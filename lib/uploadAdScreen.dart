...
class _UploadAdScreenState extends State<UploadAdScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(
          next ? "Opišite Vašu ponudu" : 'Izaberite slike',
      ...
      body: next ? SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              TextField(
                decoration: InputDecoration(hintText: 'Vaše ime'),
                onChanged: (value) {
                  this.userName = value;
                },
              ),
              SizedBox(height: 5.0),
              TextField(
                decoration: InputDecoration(hintText: 'Boj mobitela'),
                onChanged: (value) {
              ...
              SizedBox(height: 5.0),
              TextField(
                decoration: InputDecoration(hintText: 'Cijena HRK/h'),
                onChanged: (value) {
              ...
              SizedBox(height: 5.0),
              TextField(
                decoration: InputDecoration(hintText: 'Kolegij'),
                onChanged: (value) {
              ...
              Container(
                ...
                child: ElevatedButton(
                  ...
                  child: Text('Objavi oglas', style: TextStyle(color: Colors.white),),
                ),
              ),
              SizedBox(
                height: 20,
